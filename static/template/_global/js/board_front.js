...
let landtypeNames = {
  ...
  cs: {
    ...
    "wetland": "mokřad",
    "wetlands": "",
    "jungle-wetland": "džungli nebo mokřad",
    "wetland-jungle": "džungli nebo mokřad",
    "jungle-sand": "džungli nebo poušť",
    "sand-jungle": "džungli nebo poušť",
    "jungle-sands": "",
    "sands-jungle": "",
    "sand-wetland": "poušť nebo mokřad",
    "wetland-sand": "poušť nebo mokřad",
    "sands-wetland": "",
    "wetland-sands": "",
    "mountain-jungle": "hory nebo džungli",
    "jungle-mountain": "hory nebo džungli",
    "mountain-wetland": "hory nebo mokřad",
    "wetland-mountain": "hory nebo mokřad",
    "mountain-sand": "hory nebo poušť",
    "sand-mountain": "hory nebo poušť",
    "mountain-sands": "",
    "sands-mountain": "",
    "inland": "vnitrozemské území",
    "coastal": "pobřežní území",
    "land": "",
    "invaders": "",
  },
  hu: {
  ...
  switch (str) {
    ...
    case "add-presence":
      if (num === "any" && options.length === 1) {
        localize = {
          ...
          cs: `Přidání přítomnosti kdekoli`,
          ar: ``,
          zh: ``,
    ...
    case "growth-gain-card-play":
      ...
      localize = {
        ...
        cs: num > 4 ? ` +${num} hraných karet v tomto kole` : num > 1 ? ` +${num} hrané karet v tomto kole` : ` +${num} hraná karta v tomto kole`,
        ar: ``,
        zh: ``,
        hu:
          num > 1
    ...
    case "ignore-range":
      localize = {
        ...
        cs: "V tomto kole můžete ignorovat dosah schopností",
        ar: "",
        zh: "這回合你可以無視距離上限",
...
function tagSectionHeadings() {
  let sectionTitles = {
    ...
    cs: {
      growth: "RŮST",
      presence: "PŘÍTOMNOST",
      innate: "VROZENÉ SCHOPNOSTI",
      special: "ZVLÁŠTNÍ PRAVIDLA",
    },
    ar: {
      growth: "نمو",
      presence: "وجود",
